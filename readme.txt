...
1. Upload the `devsroom-dropdown-menu` folder to `/wp-content/plugins/`.
2. Activate the plugin through the `Plugins` screen in WordPress.
3. Edit a page with Elementor and search for `Devsroom Dropdown Menu`.
...
= Does the widget support nested submenu levels? =
